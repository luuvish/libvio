                          ...
                          Macroblock *currMB, int ioff, int joff)
{
    ...
    if (p_Vid->active_pps->constrained_intra_pred_flag) {
        ...
        *avail_up_right = pix_c->available ? currSlice->intra_block[pix_c->mb_addr] : 0;
        *avail_up_left  = pix_d->available ? currSlice->intra_block[pix_d->mb_addr] : 0;
    } else {
        *avail_left     = pix_a[0].available;
        *avail_up       = pix_b->available;
        *avail_up_right = pix_c->available;
 ...
 ***********************************************************************
 */
static void intra4x4_dc_pred_mbaff(Macroblock *currMB, ColorPlane pl, int ioff, int joff)
{
    Slice *currSlice = currMB->p_Slice;
    VideoParameters *p_Vid = currMB->p_Vid;  
    ...
    PixelPos pix_a[4], pix_b, pix_c, pix_d;
 ...
 ***********************************************************************
 */
static void intra4x4_vert_pred_mbaff(Macroblock *currMB, ColorPlane pl, int ioff, int joff)
{
    Slice *currSlice = currMB->p_Slice;
    ...
    imgpel **mb_pred = currSlice->mb_pred[pl];
    imgpel *imgY = (pl) ? &currSlice->dec_picture->imgUV[pl - 1][pix_b.pos_y][pix_b.pos_x]
 ...
 ***********************************************************************
 */
static void intra4x4_hor_pred_mbaff(Macroblock *currMB, ColorPlane pl, int ioff, int joff)
{
    Slice *currSlice = currMB->p_Slice;
 ...
 ***********************************************************************
 */
static void intra4x4_diag_down_right_pred_mbaff(Macroblock *currMB, ColorPlane pl, int ioff, int joff)
{
    Slice *currSlice = currMB->p_Slice;
 ...
 ***********************************************************************
 */
static void intra4x4_diag_down_left_pred_mbaff(Macroblock *currMB, ColorPlane pl, int ioff, int joff)
{
    Slice *currSlice = currMB->p_Slice;
 ...
 ***********************************************************************
 */
static void intra4x4_vert_right_pred_mbaff(Macroblock *currMB, ColorPlane pl, int ioff, int joff)
{
    Slice *currSlice = currMB->p_Slice;
 ...
 ***********************************************************************
 */
static void intra4x4_vert_left_pred_mbaff(Macroblock *currMB, ColorPlane pl, int ioff, int joff)
{
    Slice *currSlice = currMB->p_Slice;
 ...
 ***********************************************************************
 */
static void intra4x4_hor_up_pred_mbaff(Macroblock *currMB, ColorPlane pl, int ioff, int joff)
{
    Slice *currSlice = currMB->p_Slice;
 ...
 ***********************************************************************
 */
static void intra4x4_hor_down_pred_mbaff(Macroblock *currMB, ColorPlane pl, int ioff, int joff)
{
    Slice *currSlice = currMB->p_Slice;
                        ...
                        int img_block_y)       //!< location of block Y, multiples of 4
{
    ...
    switch (predmode) {
    case DC_PRED:
        intra4x4_dc_pred_mbaff(currMB, pl, ioff, joff);
        break;
    case VERT_PRED:
        intra4x4_vert_pred_mbaff(currMB, pl, ioff, joff);
        break;
    case HOR_PRED:
        intra4x4_hor_pred_mbaff(currMB, pl, ioff, joff);
        break;
    case DIAG_DOWN_RIGHT_PRED:
        intra4x4_diag_down_right_pred_mbaff(currMB, pl, ioff, joff);
        break;
    case DIAG_DOWN_LEFT_PRED:
        intra4x4_diag_down_left_pred_mbaff(currMB, pl, ioff, joff);
        break;
    case VERT_RIGHT_PRED:
        intra4x4_vert_right_pred_mbaff(currMB, pl, ioff, joff);
        break;
    case VERT_LEFT_PRED:
        intra4x4_vert_left_pred_mbaff(currMB, pl, ioff, joff);
        break;
    case HOR_UP_PRED:
        intra4x4_hor_up_pred_mbaff(currMB, pl, ioff, joff);
        break;
    case HOR_DOWN_PRED:  
        intra4x4_hor_down_pred_mbaff(currMB, pl, ioff, joff);
        break;
    default:
