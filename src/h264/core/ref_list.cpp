...
static void init_lists_p_slice(slice_t *currSlice)
{
    ...
    if (!currSlice->field_pic_flag) {
        ...
        currSlice->RefPicSize[0] = 0;
        gen_pic_list_from_frame_list(currSlice->bottom_field_flag, fs_list0, list0idx, currSlice->RefPicList[0], &currSlice->RefPicSize[0], 0);
        ...
        gen_pic_list_from_frame_list(currSlice->bottom_field_flag, fs_listlt, listltidx, currSlice->RefPicList[0], &currSlice->RefPicSize[0], 1);
    ...
    // set max size
    currSlice->RefPicSize[0] = (char) min<int>(currSlice->RefPicSize[0], currSlice->num_ref_idx_l0_active_minus1 + 1);
    currSlice->RefPicSize[1] = 0;
...
static void init_lists_b_slice(slice_t *currSlice)
{
    ...
    if (!currSlice->field_pic_flag) {
        ...
        currSlice->RefPicSize[1] = 0;
        gen_pic_list_from_frame_list(currSlice->bottom_field_flag, fs_list0, list0idx, currSlice->RefPicList[0], &currSlice->RefPicSize[0], 0);
        gen_pic_list_from_frame_list(currSlice->bottom_field_flag, fs_list1, list0idx, currSlice->RefPicList[1], &currSlice->RefPicSize[1], 0);
        ...
        gen_pic_list_from_frame_list(currSlice->bottom_field_flag, fs_listlt, listltidx, currSlice->RefPicList[0], &currSlice->RefPicSize[0], 1);
        gen_pic_list_from_frame_list(currSlice->bottom_field_flag, fs_listlt, listltidx, currSlice->RefPicList[1], &currSlice->RefPicSize[1], 1);
    ...
    // set max size
    currSlice->RefPicSize[0] = min<int>(currSlice->RefPicSize[0], currSlice->num_ref_idx_l0_active_minus1 + 1);
    currSlice->RefPicSize[1] = min<int>(currSlice->RefPicSize[1], currSlice->num_ref_idx_l1_active_minus1 + 1);
...
static void init_lists_p_slice_mvc(slice_t *currSlice)
{
    ...
    if (currSlice->svc_extension_flag == 0) {
        ...
        if (!currSlice->field_pic_flag) {
            ...
            gen_pic_list_from_frame_interview_list(currSlice->bottom_field_flag, currSlice->fs_listinterview0, currSlice->listinterviewidx0, currSlice->RefPicList[0], &currSlice->RefPicSize[0]);
        }
    }

    // set max size
    currSlice->RefPicSize[0] = (char) min<int>(currSlice->RefPicSize[0], currSlice->num_ref_idx_l0_active_minus1 + 1);
    currSlice->RefPicSize[1] = (char) min<int>(currSlice->RefPicSize[1], currSlice->num_ref_idx_l1_active_minus1 + 1);
...
static void reorder_lists(slice_t *currSlice)
{
    ...
    if (currSlice->slice_type != I_slice && currSlice->slice_type != SI_slice) {
        ...
        if (p_Vid->no_reference_picture == currSlice->RefPicList[0][currSlice->num_ref_idx_l0_active_minus1]) {
        ...
        // that's a definition
        currSlice->RefPicSize[0] = (char) currSlice->num_ref_idx_l0_active_minus1 + 1;
    }

    if (currSlice->slice_type == B_slice) {
        if (currSlice->ref_pic_list_modification_flag_l1)
            reorder_ref_pic_list(currSlice, LIST_1);
        if (p_Vid->no_reference_picture == currSlice->RefPicList[1][currSlice->num_ref_idx_l1_active_minus1]) {
            if (p_Vid->non_conforming_stream)
        ...
        // that's a definition
        currSlice->RefPicSize[1] = (char) currSlice->num_ref_idx_l1_active_minus1 + 1;
    }
}
