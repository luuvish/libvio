...
uint8_t  parse_ref_idx                (macroblock_t* mb, uint8_t list, uint8_t x0, uint8_t y0);
int16_t  parse_mvd                    (macroblock_t* mb, uint8_t list, uint8_t x0, uint8_t y0, uint8_t xy);
